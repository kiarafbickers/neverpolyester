...
const ACTIVITY_TYPES = [
	{
		...
		link: '/account/secret-admin/listing-manager',
	...
	{ type: 'new_search', verbalize: 'searched for:', icon: SearchIcon },
	{
		...
		icon: NewspaperIcon,
		link: '/account/secret-admin/blog-manager',
		linkText: 'View Post',
	},
	{
		type: 'update_post',
	...
	},
	{
		...
		link: '/account/secret-admin/comment-manager',
	...
	},
	{
		...
		icon: TagIcon,
		link: '/account/secret-admin/tag-manager',
		linkText: 'View Tag',
	},
	{
		type: 'new_category',
		...
		icon: TagsIcon,
		link: '/account/secret-admin/category-manager',
	...
	},
	{
		...
		icon: GemIcon,
		link: '/account/secret-admin/ad-manager',
		linkText: 'View Ad',
	},
	{
		type: 'new_view',
	...
	},
	{
		...
		link: '/account/secret-admin/feedback-manager',
		linkText: 'View Listing',
	},
	{
		type: 'new_promotion',
		verbalize: 'promoted:',
		icon: DollarSignIcon,
		link: '/account/secret-admin/promotion-manager',
