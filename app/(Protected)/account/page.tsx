...
export default async function Dashboard() {
  ...
  return (
    <SectionOuterContainer>
      ...
      <SubSectionInnerContainer>
        <h2 className="text-lg text-foregroung py-4">
          {LISTINGS_SETTINGS.pluralName}
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
          <div className="flex flex-col items-center justify-center bg-white rounded-lg shadow-md p-4">
            ...
            <h3 className="text-lg font-bold tracking-tight">
              Total {LISTINGS_SETTINGS.pluralName}
            </h3>
          </div>
          <div className="flex flex-col items-center justify-center bg-white rounded-lg shadow-md p-4">
            <p className="text-2xl text-muted-foreground">
        ...
        {GENERAL_SETTINGS.USE_SUBLISTINGS && (
          <>
            <h2 className="text-lg text-foregroung py-4">
              {SUBLISTINGS_SETTINGS.pluralName}
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
              <div className="flex flex-col items-center justify-center bg-white rounded-lg shadow-md p-4">
                ...
                <h3 className="text-lg font-bold tracking-tight">
                  Total {SUBLISTINGS_SETTINGS.pluralName}
                </h3>
              </div>
              <div className="flex flex-col items-center justify-center bg-white rounded-lg shadow-md p-4">
                <p className="text-2xl text-muted-foreground">
