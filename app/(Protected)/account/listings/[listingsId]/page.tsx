...
// Import Data
import { COMPANY_BASIC_INFORMATION, LISTINGS_SETTINGS } from "@/constants"; // Import Assets & Icons
import { AlertCircle } from "lucide-react";

export const metadata: Metadata = {
  title: `${LISTINGS_SETTINGS.singularName} Manager`,
};
  ...
  return (
    <SectionOuterContainer>
      <SectionTitle className="mx-0 max-w-none text-left">
        Update {LISTINGS_SETTINGS.singularName}
      </SectionTitle>
      <ListingEditor
