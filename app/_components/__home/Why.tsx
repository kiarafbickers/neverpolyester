  ...
  return (
    <div className="bg-blackDz">
      ...
      >
        ...
        {/* Polyester Process Section with updated Disclosure */}
        <Disclosure as="div">
          {({ open }) => (
            <>
              <Disclosure.Button className="flex mt-8 pb-8 mb-8 w-full items-center justify-between border-b border-mutedDz">
                  ...
                  <div>
                    ...
                    <div className="mt-4">
                      ...
                      <p className="mt-2 text-sm text-white">
                        Polyester is petroleum designed to make oil companies
                        richer and our bodies sicker. It’s packed with endocrine
                        disruptors, linked to infertility, and every time you
                        wash it, microplastics break off.
                      </p>
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="mt-4">
                      ...
                      <p className="mt-2 text-sm text-white">
                        ...
                        animals. They’re renewable, kind to your skin, and
                        naturally antibacterial. When woven into fabric, they
